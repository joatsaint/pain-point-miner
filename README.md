...
AI you use), and it'll ask which of three modes you want before doing
anything:

1. **Fully Automatic** — the steps below. Free version, one URL per run.
2. **Manual / Zero-Cost** — no API key, no install. See `manual-mode-template.md`.
3. **Builder Mode** — your AI builds it, but hands you the simple, physical
   steps yourself so you get a feel for how it's actually put together.

See `CLAUDE.md` for the full breakdown of all three.

## Setup (Option 1 — Fully Automatic)
