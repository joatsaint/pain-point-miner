...
## Who are you, and how much control do you want?

Clone the repo, open it in Claude Code (or paste `CLAUDE.md` into whatever
AI you use), and it'll ask which of three modes fits you before doing
anything:

1. **The Operator** (Fully Automatic) — "save me time." The steps below.
   Free version, one URL per run.
2. **The Explorer** (Manual / Zero-Cost) — "let me test this." No API
   key, no install. See `manual-mode-template.md`.
3. **The Builder** (Builder Mode) — "teach me the future." Your AI builds
   it, but hands you the simple, physical steps yourself so you get a
   feel for how it's actually put together.

See `CLAUDE.md` for the full breakdown of all three.

## Setup (The Operator — Fully Automatic)
